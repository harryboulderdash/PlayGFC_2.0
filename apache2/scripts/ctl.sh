...
HTTPD_PIDFILE=/Applications/drupal-7.41-1/apache2/logs/httpd.pid


HTTPD="/Applications/drupal-7.41-1/apache2/bin/httpd -f /Applications/drupal-7.41-1/apache2/conf/httpd.conf"
...
. /Applications/drupal-7.41-1/apache2/bin/envvars
